...
이번 과제에서는 한국의 35-50세 여성 소비자가 건강기능식품을 탐색할 때 느끼는 정보 탐색 비용과 불안감을 문제로 잡았습니다. 
상품 상세 페이지, 리뷰, 성분 정보, 주의사항이 흩어져 있고 광고성 정보도 많기 때문에, 사용자가 “나한테 맞는 상품인지”를 빠르게 판단하기 어렵다고 보았습니다.

그래서 React, Node.js, MySQL, LangGraph.js, OpenAI API, RAG를 사용해 채팅형 추천 MVP를 구현했습니다. 
유저는 회원가입/로그인 후 채팅방에서 자신의 건강 맥락을 온보딩으로 남기고, 이후 질문을 하면 수집한 상품 데이터와 개인 맥락을 함께 사용해 답변을 받습니다.
...
각 강조하고자 하는 부분들은 docs하위에 상세하게 작성했습니다. 참고부탁드립니다.
...
3. 새 채팅방에서 온보딩 질문 4단계에 답합니다. (하단에 있는 키워드를 사용하면 편리합니다.)
4. “요즘 피곤하고 잠을 잘 못 자는데 건강기능식품 추천해줘”처럼 추천 질문을 입력합니다.
